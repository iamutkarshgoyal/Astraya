...
export function CategoryCard({ category }: CategoryCardProps) {
  return (
    <Link
      className="group block overflow-hidden rounded-lg border border-astraya-border bg-astraya-card shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-astraya-gold/70 hover:shadow-card"
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="mt-4 font-button text-xs font-bold uppercase tracking-[0.18em] text-astraya-gold">
